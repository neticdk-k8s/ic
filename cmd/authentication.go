...
type authenticationOptions struct {
	...
	OIDCRedirectURLAuthCodeKeyboard string
...
func (o *authenticationOptions) addFlags(f *pflag.FlagSet) {
	...
	f.StringVar(&o.OIDCRedirectURLAuthCodeKeyboard, "oidc-redirect-url-authcode-keyboard", oobRedirectURI, "[authcode-keyboard] Redirect URL when using authcode keyboard")
