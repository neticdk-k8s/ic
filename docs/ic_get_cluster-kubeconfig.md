## ic get cluster-kubeconfig

Get a cluster kubeconfig

```
ic get cluster-kubeconfig [flags]
```
...
```
  ...
  -h, --help                  help for cluster-kubeconfig
```
...
###### Auto generated by spf13/cobra on 24-Sep-2024
