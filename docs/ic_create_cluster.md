...
```
      ...
      --resilience-zone string           Resilience Zone. Should be one of (platform|internal-1|innovators-1|early-adopters-1|early-majority-1|early-majority-2|late-majority-1|late-majority-2|laggards-1) (default "netic")
