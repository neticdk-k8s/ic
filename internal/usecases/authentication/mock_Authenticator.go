...
func (_m *MockAuthenticator) Authenticate(ctx context.Context, in AuthenticateInput) (*AuthResult, error) {
...
func (_e *MockAuthenticator_Expecter) Authenticate(ctx interface{}, in interface{}) *MockAuthenticator_Authenticate_Call {
	return &MockAuthenticator_Authenticate_Call{Call: _e.mock.On("Authenticate", ctx, in)}
}

func (_c *MockAuthenticator_Authenticate_Call) Run(run func(ctx context.Context, in AuthenticateInput)) *MockAuthenticator_Authenticate_Call {
...
func (_c *MockAuthenticator_Authenticate_Call) Return(_a0 *AuthResult, _a1 error) *MockAuthenticator_Authenticate_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockAuthenticator_Authenticate_Call) RunAndReturn(run func(context.Context, AuthenticateInput) (*AuthResult, error)) *MockAuthenticator_Authenticate_Call {
	_c.Call.Return(run)
	return _c
}

// Login provides a mock function with given fields: ctx, in
func (_m *MockAuthenticator) Login(ctx context.Context, in LoginInput) error {
	ret := _m.Called(ctx, in)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, LoginInput) error); ok {
		r0 = rf(ctx, in)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *MockAuthenticator_Login_Call) Return(_a0 error) *MockAuthenticator_Login_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockAuthenticator_Login_Call) RunAndReturn(run func(context.Context, LoginInput) error) *MockAuthenticator_Login_Call {
	_c.Call.Return(run)
	return _c
}
