...
```
      ...
      --resilience-zone string           Resilience Zone. One of (platform|internal-1|innovators-1|early-adopters-1|early-majority-1|early-majority-2|late-majority-1|late-majority-2|laggards-1|jysk-platform|jysk-dev|jysk-stage|jysk-prod) (default "netic")
      --api-endpoint string              Cluster API Server endpoint (url)
